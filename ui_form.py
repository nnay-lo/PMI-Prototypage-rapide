...
class Ui_Main_Window(object):
    def setupUi(self, Main_Window):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 338, 714))
        ...
        self.page.setGeometry(QRect(0, 0, 306, 713))
    ...
    def retranslateUi(self, Main_Window):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("Main_Window", u"Total Occurencies", None))
